namespace ShopCourses.Migrations
{
    ...
    public partial class AddAspIdentity : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                c => new
                    {
                        Id = c.String(nullable: false, maxLength: 128),
                        DataUser_FirstName = c.String(),
                        DataUser_LastName = c.String(),
                        DataUser_Address = c.String(),
                        DataUser_City = c.String(),
                        DataUser_NumberPhone = c.String(),
                        DataUser_Email = c.String(),
