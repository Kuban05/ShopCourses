    ...
    public class CourseInitializer : MigrateDatabaseToLatestVersion<CourseContext, Configuration>
    {
        ...
        public static void SeedCoursesData(CourseContext context)
        {
            ...
            var courses = new List<Course>
            {
                ...
                new Course(){CourseId=8, AuthorCourse="Mariusz Nowak",TitleCourse="Xml",CategoryId=6,PriceCourse=140,Bestseller=false,NamePicture="obrazekxml.png",DateAdded=DateTime.Now,DescriptionCourse="Kurs Xml - język uniwersalny."},
                new Course(){CourseId=9, AuthorCourse="Rafał Krupa",TitleCourse="C#",CategoryId=7,PriceCourse=140,Bestseller=true,NamePicture="obrazekcsharp.png",DateAdded=DateTime.Now,DescriptionCourse="Kurs C# - Poziom Zaawansowany"}
            };
        ...
        public static void SeedUsers(CourseContext db)
        {
            var userManager = new UserManager<ApplicationUser>(new UserStore<ApplicationUser>(db));
            var roleManager = new RoleManager<IdentityRole>(new RoleStore<IdentityRole>(db));

            const string name = "admin@ShopCourses.pl";
